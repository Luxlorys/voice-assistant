...
class Help:
    ...
    help_text = [
        ...
        ('Порахуй, щоб провести простий розрахунок'),
        ('Вимкни ПК, щоб завершити роботу комп"ютера'),
        ('Рестар ПК, щоб перезавантажити комп"ютер'),
        ('Ви можете поговорити зі мною спросивши як мої справи'),
        ('Дізнайтеся точну погоду в зазначеному місті')
    ]
